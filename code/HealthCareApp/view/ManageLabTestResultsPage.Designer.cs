namespace HealthCareApp.view
{
	partial class ManageLabTestResultsPage
	{
		...
		private void InitializeComponent()
		{
			...
			// cancelButton
			// 
			cancelButton.Location = new Point(465, 437);
			...
			normalityText.Location = new Point(415, 257);
			normalityText.Margin = new Padding(2, 0, 2, 0);
			normalityText.Name = "normalityText";
			normalityText.Size = new Size(94, 15);
