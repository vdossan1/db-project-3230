namespace HealthCareApp.view
{
    partial class ManageUserPage
    {
		...
		private void InitializeComponent()
		{
			...
			firstNameLabel.Location = new Point(62, 32);
			...
			lastNameLabel.Location = new Point(310, 32);
			...
			dateOfBirthLabel.Location = new Point(236, 93);
			...
			genderLabel.Location = new Point(62, 93);
			genderLabel.Margin = new Padding(2, 0, 2, 0);
			genderLabel.Name = "genderLabel";
			genderLabel.Size = new Size(25, 15);
			...
			addressOneLabel.Location = new Point(62, 266);
			addressOneLabel.Margin = new Padding(2, 0, 2, 0);
			addressOneLabel.Name = "addressOneLabel";
			addressOneLabel.Size = new Size(58, 15);
			...
			addressTwoLabel.Location = new Point(62, 344);
			addressTwoLabel.Margin = new Padding(2, 0, 2, 0);
			addressTwoLabel.Name = "addressTwoLabel";
			addressTwoLabel.Size = new Size(58, 15);
			...
			cityLabel.Location = new Point(71, 403);
			...
			stateLabel.Location = new Point(216, 400);
			...
			zipCodeLabel.Location = new Point(384, 400);
			...
			phoneNumberLabel.Location = new Point(62, 179);
			...
			ssnLabel.Location = new Point(265, 179);
			ssnLabel.Margin = new Padding(2, 0, 2, 0);
			ssnLabel.Name = "ssnLabel";
			ssnLabel.Size = new Size(28, 15);
			...
			phoneNumberErrorLabel.Location = new Point(62, 217);
			phoneNumberErrorLabel.Margin = new Padding(2, 0, 2, 0);
			phoneNumberErrorLabel.Name = "phoneNumberErrorLabel";
			phoneNumberErrorLabel.Size = new Size(145, 15);
			...
			ssnErrorLabel.Location = new Point(265, 217);
			ssnErrorLabel.Margin = new Padding(2, 0, 2, 0);
			ssnErrorLabel.Name = "ssnErrorLabel";
			ssnErrorLabel.Size = new Size(81, 15);
			...
			zipCodeErrorLabel.Location = new Point(378, 450);
			zipCodeErrorLabel.Margin = new Padding(2, 0, 2, 0);
			zipCodeErrorLabel.Name = "zipCodeErrorLabel";
			zipCodeErrorLabel.Size = new Size(108, 15);
			...
			firstNameErrorLabel.Location = new Point(62, 70);
			firstNameErrorLabel.Margin = new Padding(2, 0, 2, 0);
			firstNameErrorLabel.Name = "firstNameErrorLabel";
			firstNameErrorLabel.Size = new Size(120, 15);
			...
			lastNameErrorLabel.Location = new Point(309, 70);
			lastNameErrorLabel.Margin = new Padding(2, 0, 2, 0);
			lastNameErrorLabel.Name = "lastNameErrorLabel";
			lastNameErrorLabel.Size = new Size(116, 15);
			...
			addressOneErrorLabel.Location = new Point(62, 310);
			addressOneErrorLabel.Margin = new Padding(2, 0, 2, 0);
			addressOneErrorLabel.Name = "addressOneErrorLabel";
			addressOneErrorLabel.Size = new Size(129, 15);
			...
			sexErrorLabel.Location = new Point(65, 137);
			sexErrorLabel.Margin = new Padding(2, 0, 2, 0);
			sexErrorLabel.Name = "sexErrorLabel";
			sexErrorLabel.Size = new Size(83, 15);
			...
			dateOfBirthErrorLabel.Location = new Point(236, 137);
			dateOfBirthErrorLabel.Margin = new Padding(2, 0, 2, 0);
			dateOfBirthErrorLabel.Name = "dateOfBirthErrorLabel";
			dateOfBirthErrorLabel.Size = new Size(131, 15);
