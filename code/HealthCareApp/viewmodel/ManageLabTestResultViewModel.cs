...
namespace HealthCareApp.viewmodel
{
	...
	public class ManageLabTestResultViewModel
	{
		...
		/// </summary>
		public string ResultNormalityValidationMessage => this.ValidationErrors.ContainsKey(nameof(this.ResultNormality))
		...
		private void UpdateLabTestResult()
		{
			...
			var newLabTestResult = new LabTestResult(this.SelectedLabTestResult.VisitId, this.SelectedLabTestResult.TestCode, this.TestResult, 
